...
<center style="margin-top:2%">
	<form action="${pageContext.request.contextPath }/toExamPage.action" method="post">
		<table cellpadding="15px">
			...
			<tr>
				<td colspan="2" align="center"><input id="subm" type="submit" value="确定" class="easyui-linkbutton" style="padding:5px;background:#fafafa;width:70px;border:1px solid #ccc"></td>
			</tr>
		</table>
	</form>
		<br>
