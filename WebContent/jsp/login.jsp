...
<div style="margin-top:3%;margin-left:40%">
    <form action="${pageContext.request.contextPath }/login.action" method="post">
        <table cellpadding="15px">
            ...
            <tr>
                <td><input type="submit" value="登 录" class="easyui-linkbutton" style="padding:5px;background:#fafafa;width:70px;border:1px solid #ccc"></td>
                <td align="right"><input type="button" id="btn" value="注 册" class="easyui-linkbutton" style="padding:5px;background:#fafafa;width:70px;border:1px solid #ccc"></td>
            </tr>
        </table>
    </form>
</div>
